...
class Like(models.Model):
    ...
    post = models.ForeignKey(to="posts.Post", on_delete=models.CASCADE, null=True, blank=True)
    comment = models.ForeignKey(to="comments.Comment", on_delete=models.CASCADE, null=True, blank=True)
